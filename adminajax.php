...
if(isset($_POST['done'])){
    ...
    $query = "insert into messages(u_email, sender, message) values ('ayush804@gmail.com', 'admin', '$message')";
...
if(isset($_POST['display'])){
                ?>
                    ...
                    <ul class="chat">
                <?php
                $query = "select sender, message from messages where u_email='ayush804@gmail.com' order by no";
