    ...
    <body>
        ...
        <div class="container container_style">       
            <table class="table">
                ...
                <?php
                $query="select users_items.pid, products.name, products.price FROM users_items INNER JOIN products on users_items.pid=products.id where users_items.uid='$id' and status='Added to Cart'";
